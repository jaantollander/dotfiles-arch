...
ln -sf "$DOTMODULE/xorg/config/@login.sh" "$XDG_CONFIG_HOME/shell/login/xorg.sh"

mkdir -p "$XDG_CONFIG_HOME/shell/interactive"
ln -sf "$DOTMODULE/xorg/config/@interactive.sh" "$XDG_CONFIG_HOME/shell/interactive/xorg.sh"
